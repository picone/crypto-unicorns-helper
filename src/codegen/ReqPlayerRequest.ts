...
export interface IReqPlayerRequestArgs {
    type?: string;
    data?: Buffer;
}
export class ReqPlayerRequest {
    public type?: string;
    public data?: Buffer;
    constructor(args?: IReqPlayerRequestArgs) {
    ...
    public static read(input: thrift.TProtocol): ReqPlayerRequest {
        ...
        input.readStructEnd();
        return new ReqPlayerRequest(_args);
    }
}
